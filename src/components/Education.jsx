...
const EducationItem = ({ school, degree, period, location, cgpa, logo, useVidyaLogo, color = "var(--education-accent)" }) => {
  const finalLogo = useVidyaLogo ? vidyaLogo : logo;
  return (
    <CyberCard 
      ...
      <div style={{ 
        ...
        {finalLogo && (
          <div style={{ 
            ...
            <img src={finalLogo} alt={school} style={{ maxWidth: '100%', maxHeight: '100%', objectFit: 'contain' }} />
          </div>
        )}
